export default function GetOrganized() {
  return (
    <div id="organized" className="py-10 lg:py-14 container mx-auto px-2 -scroll-mt-8">
      {/* Grid */}
      <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        <div>
          <img className="rounded-xl" src="https://images.unsplash.com/photo-1648737963503-1a26da876aca?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&h=900&q=80" alt="Get Organized" />
        </div>
        {/* End Col */}
        <div className="mt-5 sm:mt-10 lg:mt-0">
          <div className="space-y-6 sm:space-y-8">
            ...
            <ul className="space-y-2 sm:space-y-4">
              <li className="flex space-x-3 font-medium">
                {/* Solid Check */}
                ...
                <span className="text-sm sm:text-base text-gray-500">
                  Tasks mastered, no detail spared
                </span>
              </li>
              <li className="flex space-x-3 font-medium">
                {/* Solid Check */}
